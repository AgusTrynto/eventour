...
{
    public function index(NeuralContentRecommendationService $recommendationService)
    {
        $user = Auth::user();
    ...
    public function recommendations(NeuralContentRecommendationService $recommendationService)
    {
        ...
        return response()->json([
            'html' => view('user.partials.recommendations', compact('recommendedEvents'))->render(),
        ]);
    }
}
