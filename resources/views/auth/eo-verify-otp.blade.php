...
<head>
    ...
    <title>Verifikasi OTP EO - EvenTour</title>
    ...
    <main class="main-content">
        <div class="otp-card">
            ...
            <div class="heading">
                ...
                <span class="badge">VERIFIKASI EMAIL EO</span>
            ...
            <form action="{{ route('eo.register.otp.verify') }}" method="POST" class="otp-form">
                @csrf
                ...
                @if (session('otp_error'))
                    <div class="error-box">{{ session('otp_error') }}</div>
                @endif
            ...
            <div class="resend-section">
                ...
                <form action="{{ route('eo.register.otp.resend') }}" method="POST" id="resend-form">
                    @csrf
            ...
            <a href="{{ route('eo.register') }}" class="back-link">
                ← Kembali & ubah data
            </a>
